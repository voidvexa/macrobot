...
DEFAULT_SERIES_METADATA = [
    ...
    {"key": "real_pce", "label": "Real PCE", "unit": " B", "source": "fred", "threshold": 0.0, "description": "Real Personal Consumption Expenditures (PCEC96, billions of chained dollars, current BEA reference year, SAAR)"},
    {"key": "real_gdp", "label": "Real GDP", "unit": " B", "source": "fred", "threshold": 0.0, "description": "Real Gross Domestic Product (GDPC1, billions of chained dollars, current BEA reference year, SAAR)"},
